...
export const TranslatePopoverButton = React.memo(({ onSelectLang, lang, disabled }) => {
...
TranslatePopoverButton.propTypes = {
  onSelectLang: PropTypes.func.isRequired,
  disabled: PropTypes.bool,
  lang: PropTypes.string
};

TranslatePopoverButton.displayName = "TranslatePopoverButton";
